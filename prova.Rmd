...
```
Where $y_{u,i)$ is the real rating, $\hat{y}_{u,i}$ is the predicted rating
...
So we can confirm that the final model for our projects is the following:
